    ...
    if (this.state.userToken) {
      ...
      Axios.post("http://127.0.0.1:8000/api/driver/r/route/", {
        ...
        .then(response => {
          ...
          if (
            response.data.second === undefined ||
            response.data.second.length == 0
          ) {
          ...
          return Axios.get(
            `https://maps.googleapis.com/maps/api/directions/json?origin=${this.state.start.toString()}
            ...
            .then(response => {
              ...
              this.setState({
                start_destination_object:
                  response.data.routes[0].legs[0].start_location
              });
              this.setState({
                currentPos: response.data.routes[0].legs[0].start_location
              });
              this.setState({
                currentPosArray: response.data.routes[0].legs[0].start_location
              });
              this.setState({
              ...
              this.setState({
                first_destination_object:
                  response.data.routes[0].legs[0].end_location
              });
    ...
    return (
      <React.Fragment>
        ...
        >
          ...
          <Marker
            onClick={this.onMarkerClick}
            name={"first destination: " + this.state.first_destination_name}
            position={this.state.first_destination_object}
          />
          <Marker
            onClick={this.onMarkerClick}
            name={"final destination: " + this.state.final_destination_name}
            position={this.state.final_destination_object}
          />
          <InfoWindow
